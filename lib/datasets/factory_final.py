...
for year in ['2007', '2012']:
  for split in ['train', 'val', 'trainval', 'test']:
    ...
    __sets[name] = (lambda split=split, year=year: pascal_voc(split, year,'/home/divyam/FRCN/faster-rcnn.pytorch/data/src/cityscapes/VOCdevkit2007/' ))

for year in ['2007', '2012']:
  for split in ['train', 'val', 'trainval', 'test']:
    name = 'fcity_{}_{}'.format(year, split)
    __sets[name] = (lambda split=split, year=year: pascal_voc(split, year,'/home/divyam/FRCN/faster-rcnn.pytorch/data/tar/foggy_cityscapes/VOCdevkit2007/' ))
