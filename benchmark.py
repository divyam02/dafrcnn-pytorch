...
if __name__ == '__main__':
  ...
  imdb, roidb, ratio_list, ratio_index = combined_roidb(args.imdb_name, domain='src')
  ...
  for epoch in range(args.start_epoch, args.max_epochs + 1):
    ...
    for step in range(iters_per_epoch):
      ...
      rois, cls_prob, bbox_pred, rpn_loss_cls, rpn_loss_box, RCNN_loss_cls, RCNN_loss_bbox, rois_label, _, _ = fasterRCNN(im_data, im_info, gt_boxes, num_boxes, is_target=False)
